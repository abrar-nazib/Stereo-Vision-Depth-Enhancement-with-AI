...
chessboardSize = (
    8,
    6,
)  # Default 9, 6 there is always one more square than the number of inner corners in each dimension.
frameSize = (640, 480)
...
# Custom size of the chessboard squares in mm
size_of_chessboard_squares_mm = 161.5 / 7
...
imagesRight = sorted(glob.glob(os.path.join(current_dir, "data", "stereoL", "*.jpg")))
imagesLeft = sorted(glob.glob(os.path.join(current_dir, "data", "stereoR", "*.jpg")))
